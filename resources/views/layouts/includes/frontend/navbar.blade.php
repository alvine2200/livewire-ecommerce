         ...
         <div class="container-fluid">
             <div class="row">
                 <div class="col-md-2 my-auto d-none d-sm-none d-md-block d-lg-block">
                     <h5 class="brand-name" style="font-size: 18px; font-weight:bold;!important ">Alvine Ecom</h5>
                 </div>
                        ...
                        @else
                         ...
                         <li class="nav-item dropdown">
                             ...
                             <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                 ...
                                 <li><a class="dropdown-item" href="{{ url('view_cart') }}"><i class="fa fa-shopping-cart"></i> My
                                         Cart</a></li>
                                 <li>
